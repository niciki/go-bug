...
func (srv *Server) WithLog() *Server {
	if srv.httpFouService != nil {
		srv.httpFouService = srv.FouService().WithLog()
	}
	return srv
}
...
func (srv *Server) WithTrace() *Server {
	if srv.httpFouService != nil {
		srv.httpFouService = srv.FouService().WithTrace()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	if srv.httpFouService != nil {
		srv.httpFouService = srv.FouService().WithMetrics()
	}
	return srv
}

func (srv *Server) FouService() *httpFouService {
	return srv.httpFouService
}
